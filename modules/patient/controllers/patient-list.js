// import admin
angular.module('patient').controller('patientCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route, $filter) {

  $rootScope.title = "Patient";

  $('#dashboardindex1').removeClass("active");
